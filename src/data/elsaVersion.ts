 ...
 * Elsa Core / Studio release line. The 3.8.0 template package is prepared in
 * elsa-workflows/elsa-templates PR #4 (Elsa Core / Studio 3.8.0 references,
 * CShells 0.0.28, .NET 10 generated projects) and is not tagged or published
 * to NuGet.org yet. Do NOT describe the NuGet or preview feeds as verified
 * until the tag exists and the feeds are confirmed.
 * Track: https://github.com/elsa-workflows/elsa-templates/pull/4
 */
export const ELSA_TEMPLATES_VERSION = "3.8.0";

/** Forthcoming template release tag (not published at time of writing). */
export const ELSA_TEMPLATES_RELEASE_URL =
  "https://github.com/elsa-workflows/elsa-templates/releases/tag/3.8.0";

/** Preparation PR for the 3.8.0 template package. */
export const ELSA_TEMPLATES_PR_URL =
  "https://github.com/elsa-workflows/elsa-templates/pull/4";
